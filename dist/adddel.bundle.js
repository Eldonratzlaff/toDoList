...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"reIndex\": () => (/* binding */ reIndex)\n/* harmony export */ });\n/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index */ \"./src/index.js\");\n\n\n// reindex\nconst reIndex = () => {\n  for (let i = 0; i < _index__WEBPACK_IMPORTED_MODULE_0__.tasks.length; i += 1) {\n    _index__WEBPACK_IMPORTED_MODULE_0__.tasks[i].index = i + 1;\n  }\n  localStorage.setItem('tasks', JSON.stringify(_index__WEBPACK_IMPORTED_MODULE_0__.tasks));\n};\n\n// remove an element\n\nwindow.deletebtn = (index) => {\n  const result = _index__WEBPACK_IMPORTED_MODULE_0__.tasks.filter((item) => item.index !== index);\n  const newtasks = result;\n  for (let i = 0; i < newtasks.length; i += 1) {\n    newtasks[i].index = i + 1;\n  }\n  localStorage.setItem('tasks', JSON.stringify(newtasks));\n  window.location.reload();\n};\n\n// checket\nwindow.checkboxx = (i) => {\n  if (_index__WEBPACK_IMPORTED_MODULE_0__.tasks[i].Completed === false) {\n    _index__WEBPACK_IMPORTED_MODULE_0__.tasks[i].Completed = true;\n  } else { _index__WEBPACK_IMPORTED_MODULE_0__.tasks[i].Completed = false; }\n  localStorage.setItem('tasks', JSON.stringify(_index__WEBPACK_IMPORTED_MODULE_0__.tasks));\n};\n\n\n//    export default addlist ;\n\n//# sourceURL=webpack://todolist/./src/adddel.js?");
